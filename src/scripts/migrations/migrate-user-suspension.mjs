...
// Run with: node -r dotenv/config src/scripts/migrations/migrate-user-suspension.mjs

import mongoose from "mongoose";
import User from "../../lib/models/userSchema.js";
  ...
  try {
    switch (command) {
      ...
      default:
        console.log("Usage:");
        console.log(
          "  node -r dotenv/config src/scripts/migrations/migrate-user-suspension.mjs migrate"
        );
        console.log(
          "  node -r dotenv/config src/scripts/migrations/migrate-user-suspension.mjs rollback"
        );
        console.log(
          "  node -r dotenv/config src/scripts/migrations/migrate-user-suspension.mjs status"
        );
    }
  } catch (error) {
