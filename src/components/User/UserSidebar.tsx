...
interface UserSidebarProps {
    ...
    isMobile?: boolean; // Whether the app is in mobile view
    onClose?: () => void; // Function to close the sidebar (for mobile)
}
...
const Sidebar: FC<UserSidebarProps> = ({ onNavigate, activeComponent, isMobile, onClose }) => {
