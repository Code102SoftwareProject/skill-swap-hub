...
export default function AdminModerationPanel() {
  ...
  return (
    <div className="mt-6">
      {/* Improved Header & Search Bar */}
      <div className="mb-6">
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl font-bold text-gray-800">Suggestions Moderation Panel</h2>
      ...
      {/* Tabs */}
      <div className="mb-6">
        <div className="border-b border-gray-200 bg-gray-50 rounded-t-lg px-2 py-2">
            ...
            <>
              <thead className="bg-indigo-50 dark:bg-indigo-900 sticky top-0 z-10">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Max/Day</th>
                ...
                {paginatedUsers.length === 0 ? (
                  ...
                  paginatedUsers.map((user) => {
                    ...
                    <tr key={user.userId} className={`${user.status === 'Suspicious' ? 'bg-red-50' : ''} hover:bg-gray-50`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className={`text-sm font-medium ${user.maxSuggestionsIn1Day > 10 ? 'text-red-600' : 'text-gray-700'}`}>{user.maxSuggestionsIn1Day}</div>
                      </td>
